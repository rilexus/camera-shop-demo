          ...
          <Grid gutter={"1em"}>
            <Grid.Item sm={100} md={50}>
              <P>
                ...
                tempora temporibus voluptate. Debitis dolorem earum eveniet
                itaque non numquam praesentium sit voluptate!
              </P>
              <P>
                Accusamus delectus, incidunt! Aliquid cum eius inventore,
                molestias provident quibusdam! A accusantium consequatur
                doloribus inventore, iste maiores officia quam quisquam tenetur
                veniam!
              </P>
              <P>
                Architecto ducimus fugit hic in ipsa molestias nostrum
                repellendus sit ut? Aspernatur cum dicta eveniet facilis id
                impedit iusto laboriosam repellat velit?
              </P>
            </Grid.Item>
            <Grid.Item sm={100} md={50}>
              <img
